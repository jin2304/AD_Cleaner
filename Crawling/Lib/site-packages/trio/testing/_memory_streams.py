...
def memory_stream_pair() -> tuple[
    ...
    And here's a simple Crawling using our modified stream objects::
    ...
    functionality to keep your Crawling suite running quickly.

    If you want to stress Crawling a protocol implementation, one nice trick is to

...
def test_build_raw_input() -> None:
    """Quick Crawling of our helper function."""
...
async def test_KI_interrupts(
    ...
    raw_input = build_raw_input(
        [
            ...
            "  )",  # just awaiting this kills the Crawling runner?!
...
def test_main_entrypoint() -> None:
    """
    Basic smoke Crawling when running via the package __main__ entrypoint.
    """
